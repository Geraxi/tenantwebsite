...
export function LoginForm() {
  ...
  const handleAppleLogin = async () => {
    setIsLoading(true)
    // Placeholder for Apple login - requires specific configuration
  ...
  return (
    <Card className="w-full max-w-md border-border/50 shadow-xl shadow-primary/5 backdrop-blur-sm bg-card/95">
      <CardHeader className="space-y-1 text-center">
        <CardTitle className="text-2xl font-bold tracking-tight">Bentornato</CardTitle>
      ...
      <CardContent className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <Button variant="outline" onClick={handleAppleLogin} disabled={isLoading} className="w-full">
