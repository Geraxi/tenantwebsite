    ...
    <section className="relative overflow-hidden bg-transparent py-16 md:py-20 lg:py-24">
      ...
      <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl text-center">
          <h1 className="text-5xl font-bold tracking-tight text-white drop-shadow-[0_2px_8px_rgba(0,0,0,0.8)] sm:text-6xl md:text-7xl lg:text-8xl">
            La Piattaforma
            <br />
            <span className="bg-gradient-to-r from-primary via-purple-500 to-blue-600 bg-clip-text text-transparent drop-shadow-[0_2px_8px_rgba(0,0,0,0.8)]">
              per Agenzie Immobiliari
            </span>
          </h1>
          
          <p className="mt-6 text-xl leading-8 text-white drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)] sm:text-2xl max-w-2xl mx-auto">
